        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Orientacao>(e =>
            {
                e.HasOne(d => d.TipoOrientacao)
                    .WithMany(p => p.Orientacao)
                    .HasForeignKey(d => d.IdTipoOrientacao)
                    .HasConstraintName("FK_IdTipoOrientacao");
                ...
                e.HasOne(d => d.Projeto)
                    .WithMany(p => p.Orientacao)
                    .HasForeignKey<Orientacao>(d => d.IdProjetoOrientacao)
                    .HasConstraintName("PFK_IdProjetoOrientacao");

                e.HasOne(d => d.Professor)
                    .WithMany(p => p.Orientacao)
                    .HasForeignKey<Orientacao>(d => d.IdPessoaProfessorOrientacao)
                    .HasConstraintName("PFK_PessoaProfessorOrientacao");
